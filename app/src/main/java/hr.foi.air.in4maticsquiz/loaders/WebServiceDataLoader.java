package hr.foi.air.in4maticsquiz.loaders;
...
import hr.foi.air.in4maticsquiz.ws.WebServiceAsyncTask;
import hr.foi.air.in4maticsquiz.ws.WebServiceParams;
import hr.foi.air.in4maticsquiz.ws.WebServiceResultHandler;

/**
 * Created by Matija Popijač on 10.11.2015..
 * klasa za slanje zahtjeva za dohvaćanje podataka iz baze,
 * te spremanja podataka u lokalnu bazu
 */
...
public class WebServiceDataLoader extends DataLoader {
    ...
    public void LoadData(Activity activity) {
        ...
        /*
            šaljemo zahtijev za dohvaćanje podataka sa web servisa sa definiranim parametrima
         */
    ...
    WebServiceResultHandler getAllTip_korisnikaHandler = new WebServiceResultHandler() {
        ...
        public void handleResult(String result, boolean ok, long timestamp) {
            if (ok) {
                try {
                    //parsiranje dobivenog result-a (jsonDecoding)
                    ...
                    for (Tip_korisnika t : tip_korisnikas) {
                        ...
                        //ako nije duplikat i ako nije obrisan
    ...
    /*
        metoda za dohvaćanje timestamp-a iz azuriranje.xml ovisno o kojoj tablici se radi
     */
    ...
    /*
        metoda za postavljanje timestamp-a u azuriranje.xml ovisno o kojoj tablici se radi
     */
